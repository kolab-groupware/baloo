...
#include <../pim/agent/calendarindexer.h>
...
#include <../pim/search/calendar/calendarsearchstore.h>
...
private Q_SLOTS:
    void init() {
        ...
        calendarDir = QDir::tempPath() + "/searchplugintest/baloo/calendar/";
        ...
        Baloo::CalendarSearchStore *calendarSearchStore = new Baloo::CalendarSearchStore(this);
