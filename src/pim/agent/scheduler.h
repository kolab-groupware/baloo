...
public:
    virtual ~JobFactory();
    virtual CollectionIndexingJob* createCollectionIndexingJob(Index& index, const Akonadi::Collection& col, const QList<Akonadi::Item::Id>& pending, bool fullSync, QObject* parent = 0);
};
...
private:
    ...
    QMap<Akonadi::Collection::Id, QQueue<Akonadi::Item::Id> > m_queues;
    QQueue<Akonadi::Collection::Id> m_collectionQueue;
    Index& m_index;
    KJob *m_currentJob;
    QTimer m_processTimer;
    QMap<Akonadi::Collection::Id, qint64> m_lastModifiedTimestamps;
